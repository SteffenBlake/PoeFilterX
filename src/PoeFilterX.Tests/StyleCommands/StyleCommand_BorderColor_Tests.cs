...
{
    public class StyleCommand_BorderColor_Tests
    {
        private StyleCommandParser Parser { get; } = new();

        protected const string COMMAND = "border-color";
        ...
        public void BorderColor_InvalidArgs_Throws(string args)
        {
            // Assert
        ...
        public byte[] BorderColor_HexValues(string args)
        {
            // Arrange
            ...
            // Assert
            Assert.IsNotNull(filterblock.SetBorderColor);
            return new[] { 
                filterblock.SetBorderColor.Value.A, 
                filterblock.SetBorderColor.Value.R, 
                filterblock.SetBorderColor.Value.G, 
                filterblock.SetBorderColor.Value.B, 
            };
        }
        ...
        public byte[] BorderColor_ARGBValues(string args)
        {
            // Arrange
            var filterblock = new FilterBlock();
        ...
        public void BorderColorAlpha_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public void BorderColorRed_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public void BorderColorGreen_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public void BorderColorBlue_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }

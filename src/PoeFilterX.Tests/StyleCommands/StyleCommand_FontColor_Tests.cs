...
{
    public class StyleCommand_FontColor_Tests
    {
        private StyleCommandParser Parser { get; } = new();

        protected const string COMMAND = "font-color";
        ...
        public void FontColor_InvalidArgs_Throws(string args)
        {
            // Assert
        ...
        public byte[] FontColor_HexValues(string args)
        {
            // Arrange
            ...
            // Assert
            Assert.IsNotNull(filterblock.SetTextColor);
            return new[] { 
                filterblock.SetTextColor.Value.A, 
                filterblock.SetTextColor.Value.R, 
                filterblock.SetTextColor.Value.G, 
                filterblock.SetTextColor.Value.B, 
            };
        }
        ...
        public byte[] FontColor_ARGBValues(string args)
        {
            // Arrange
            var filterblock = new FilterBlock();
        ...
        public void FontColorAlpha_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public byte[] FontColorAlpha_Values(string args)
        {
            // Arrange
            var filterblock = new FilterBlock();
            filterblock.SetTextColor = Color.FromArgb(50, 100, 100, 100);
        ...
        public void FontColorRed_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public byte[] FontColorRed_Values(string args)
        {
            // Arrange
            var filterblock = new FilterBlock();
            filterblock.SetTextColor = Color.FromArgb(100, 50, 100, 100);
        ...
        public void FontColorGreen_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public byte[] FontColorGreen_Values(string args)
        {
            // Arrange
            var filterblock = new FilterBlock();
            filterblock.SetTextColor = Color.FromArgb(100, 100, 50, 100);
        ...
        public void FontColorBlue_InvalidArgs_Throws(string args)
        {
            // Assert
            Assert.Throws<ParserException>(() => Parser.Parse(args));
        }
        ...
        public byte[] FontColorBlue_Values(string args)
        {
            // Arrange
            var filterblock = new FilterBlock();
            filterblock.SetTextColor = Color.FromArgb(100, 100, 100, 50);
